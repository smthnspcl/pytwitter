...
class User(object):
    ...
    def get_steam_items(self, c=1000, download_media=False, download_path=None):
        if download_media and download_path is None:
            RetardedUserError.throw("provide a download path if you want the media downloaded.")
